...
pozoqod and pozoqo-qt by interacting with them through the RPC and P2P
interfaces.
...
Many Dash specific tests require pozoqo_hash. To install it:

- Clone the repo `git clone https://github.com/pozoqopay/pozoqo_hash`
- Install pozoqo_hash `cd pozoqo_hash && python3 setup.py install`
