...
"""Test the pozoqo specific ZMQ notification interfaces."""
...
class DashZMQTest (DashTestFramework):
    def set_test_params(self):
        ...
        self.set_pozoqo_test_params(5, 4, fast_dip3_enforcement=True, extra_args=extra_args)
    ...
    def run_test(self):
        self.subscribers = {}
        # Check that pozoqod has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all pozoqo related ZMQ publisher
