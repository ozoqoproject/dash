...
#ifndef POZOQO_CRYPTO_BLS_H
#define POZOQO_CRYPTO_BLS_H
...
// bls-pozoqo uses relic, which may define DEBUG and ERROR, which leads to many warnings in some build setups
#undef ERROR
#undef DEBUG
