...
void SendCoinsDialog::send(QList<SendCoinsRecipient> recipients)
{
    ...
    if (m_coin_control->IsUsingCoinJoin()) {
        ...
        if (nInputs >= 10 && m_coin_control->IsUsingCoinJoin()) {
            ...
            questionString.append("<a style='" + GUIUtil::getThemedStyleQString(GUIUtil::ThemedStyle::TS_COMMAND) + "' href=\"https://docs.pozoqo.tech/en/stable/wallets/pozoqo/coinjoin-instantsend.html#inputs\">");
