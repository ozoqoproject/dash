...
public:
    CMainParams() {
        ...
        consensus.nBudgetPaymentsStartBlock = 614; // actual historical value
        ...
        consensus.DIP0003EnforcementHeight = 600;
        consensus.DIP0003EnforcementHash = uint256S("");
        consensus.DIP0008Height = 700; // 00000000000000112e41e4b3afda8b233b8cc07c532d2eac5de097b68358c43e
        ...
        consensus.nPowTargetTimespan = 10 * 60; // Pozoqo: 1 day
        consensus.nPowTargetSpacing = 10 * 60; // Pozoqo: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.nPowKGWHeight = 20;
        consensus.nPowDGWHeight = 30;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 1675123200; // Feb 5th, 2017
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1706659200; // Feb 5th, 2018

        // Deployment of DIP0001
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nStartTime = 1675123200; // Oct 15th, 2017
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nTimeout = 1706659200; // Oct 15th, 2018
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nWindowSize = 500;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nThresholdStart = 400; // 80% of 4032

        // Deployment of BIP147
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].bit = 2;
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nStartTime = 1675123200; // Apr 23th, 2018
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nTimeout = 1706659200; // Apr 23th, 2019
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nWindowSize = 500;
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nThresholdStart = 400; // 80% of 4032

        // Deployment of DIP0003
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].bit = 3;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nStartTime = 1675123200; // Jan 1st, 2019
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nTimeout = 1706659200; // Jan 1st, 2020
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nWindowSize = 500;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nThresholdStart = 400; // 80% of 4032

        // Deployment of DIP0008
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].bit = 4;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nStartTime = 1675123200; // May 15th, 2019
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nTimeout = 1706659200; // May 15th, 2020
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nWindowSize = 500;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nThresholdStart = 400; // 80% of 4032

        // Deployment of Block Reward Reallocation
        consensus.vDeployments[Consensus::DEPLOYMENT_REALLOC].bit = 5;
        consensus.vDeployments[Consensus::DEPLOYMENT_REALLOC].nStartTime = 1675123200; // Oct 1st, 2020
        consensus.vDeployments[Consensus::DEPLOYMENT_REALLOC].nTimeout = 1706659200; // Oct 1st, 2021
        consensus.vDeployments[Consensus::DEPLOYMENT_REALLOC].nWindowSize = 500;
        consensus.vDeployments[Consensus::DEPLOYMENT_REALLOC].nThresholdStart = 400; // 80% of 4032
        consensus.vDeployments[Consensus::DEPLOYMENT_REALLOC].nThresholdMin = 300; // 60% of 4032
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0020].nStartTime = 1675123200; // July 1st, 2021
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0020].nTimeout = 1706659200; // July 1st, 2022
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0020].nWindowSize = 500;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0020].nThresholdStart = 400; // 80% of 4032
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0020].nThresholdMin = 300; // 60% of 4032
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0024].nStartTime = 1675123200; // Tuesday, August 15, 2022 12:00:00 AM
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0024].nTimeout = 1706659200;   // Tuesday, August 15, 2023 12:00:00 AM
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0024].nWindowSize = 500;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0024].nThresholdStart = 400; // 80% of 4032
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0024].nThresholdMin = 300;   // 60% of 4032
...
//        FindMainNetGenesisBlock(1675160653, 0x20001fff, "main");
        genesis = CreateGenesisBlock(1675160653, 823, 0x20001fff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00076c5ff925e35e8a582d18d9de169471e5498cd79361777dc7c0eb404f01f2"));
        assert(genesis.hashMerkleRoot == uint256S("0x699e9003f1b0be7a9f5cc0163c333136b10271385465e72b195953c8a3eaa683"));
        ...
        vSeeds.emplace_back("dnsseed-1.pozoqo.tech");
        vSeeds.emplace_back("dnsseed-2.pozoqo.tech");
        vSeeds.emplace_back("129.151.165.124");
        vSeeds.emplace_back("129.151.185.30");
        ...
        // Pozoqo BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // Pozoqo BIP44 coin type is '950'
        nExtCoinType = 950;
        ...
        vSporkAddresses = {"P92W3H1rxEWq9mJUu9u9tE1ZkpNWJDny4T"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = {
            {
                {0, uint256S("0x00076c5ff925e35e8a582d18d9de169471e5498cd79361777dc7c0eb404f01f2")},
            }
        };

        // getchaintxstats 17280 000000000000001d531f36005159f19351bd49ca676398a561e55dcccb84eacd
        chainTxData = ChainTxData{
                1675160653, // * UNIX timestamp of last known number of transactions (Block 1718597)
...
public:
    CTestNetParams() {
       ...
       genesis = CreateGenesisBlock(1675160653, 823, 0x20001fff, 1, 50 * COIN);
        ...
        vSeeds.emplace_back("testnet-seed.pozoqodot.io"); // Just a static list of stable node(s), only supports x9

        // Testnet Pozoqo addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet Pozoqo script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Pozoqo BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Pozoqo BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Pozoqo BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
       ...
       genesis = CreateGenesisBlock(1675160653, 823, 0x20001fff, 1, 50 * COIN);
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("pozoqoevo.org",  "devnet-seed.pozoqoevo.org"));
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
       ...
       genesis = CreateGenesisBlock(1675160653, 823, 0x20001fff, 1, 50 * COIN);
        ...
        // Regtest Pozoqo addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Pozoqo script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Pozoqo BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Pozoqo BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Pozoqo BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
