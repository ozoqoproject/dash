...
UniValue importaddress(const JSONRPCRequest& request)
{
    ...
    "as change, and not show up in many RPCs.\n",
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The Pozoqo address (or hex-encoded script)"},
...
UniValue dumpwallet(const JSONRPCRequest& request)
{
    ...
    // produce output
    file << strprintf("# Wallet dump created by Pozoqo Core %s\n", CLIENT_BUILD);
    ...
    UniValue obj(UniValue::VOBJ);
    obj.pushKV("pozoqoversion", CLIENT_BUILD);
