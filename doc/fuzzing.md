...
# libFuzzer" on https://github.com/ozoqoproject/pozoqo/blob/develop/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/ozoqoproject/pozoqo/blob/develop/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/ozoqoproject/pozoqo/blob/develop/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/ozoqoproject/pozoqo/tree/develop/src/test/fuzz).
...
with certain assembly code from Pozoqo Core's code. See [developer notes on sanitizers](https://github.com/ozoqoproject/pozoqo/blob/develop/doc/developer-notes.md#sanitizers)
