...
# Copyright (c) 2019-2023 The Pozoqo Core developers
...
Arguments:
    <base_directory> - The base directory of a Pozoqo Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Pozoqo Core developers'
...
Arguments:
    <base_directory> - The base directory of Pozoqo Core source code repository.
"""
...
CPP_HEADER = '''
// Copyright (c) %s The Pozoqo Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
'''
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The Pozoqo Core developers'
                 % (filename))
...
Arguments:
    <file> - A source file in the Pozoqo Core repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Pozoqo
